...
function ProjectHeader({activeTab, setActiveTab}: Props) {
  ...
  return (
    <div className='px-4 xl:px-6'>
        ...
        />
        <div className='pb-6 pt-6 lg:mb-4 lg:pt-8'>
            <Header name="Dashboard"
              buttonComponent={
                ...
                >
                    <PlusSquare className="mr-2 h-5 w-5" /> Nova Tabela
                </button>
              }
            />
        </div>
        ...
        <div className='flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] p-2 dark:border-stroke-dark md:items-center'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <div className='relative'>
                    <input type="text" placeholder="Pesquisar Task"
